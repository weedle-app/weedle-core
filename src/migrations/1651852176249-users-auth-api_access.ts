...
export class usersAuthApiAccess1651852176249 implements MigrationInterface {
  name = 'usersAuthApiAccess1651852176249';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "api_access_keys" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "active" boolean NOT NULL DEFAULT true, "deleted" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "api_key" character varying NOT NULL, "server_url" character varying NOT NULL, "auth_id" character varying NOT NULL, "authId" uuid, CONSTRAINT "PK_7b3cd288604ed08f9ccd6195083" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "api_access_keys" ADD CONSTRAINT "FK_946ffbb6c852c2bfea1cf696ce1" FOREIGN KEY ("authId") REFERENCES "auth"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "api_access_keys" DROP CONSTRAINT "FK_946ffbb6c852c2bfea1cf696ce1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_32ddc1ae708e8261a870a6eb3e6"`,
    );
